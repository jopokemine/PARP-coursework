...
public class ParallelMD extends Thread {
    ...
    public static void main(String args[]) throws Exception {
        ...
        ParallelMD[] threads = new ParallelMD[P];
        for (int me = 0; me < P; me++) {
            threads[me] = new ParallelMD(me);
            threads[me].start();
        }
    ...
    static class Display extends JPanel {
        ...
        Display() {
            ...
            JFrame frame = new JFrame("ParallelMD");
